        ...
        - choose <context.item.material.name>:
            - case wooden_axe:
                - if <yaml[<[data]>].[quests.active.WoodTools.stages.1.objectives.1.progress]> == 0:
                    ...
                    - run QuestStageProgressHandler def:WoodTools|1 player:<player>
            - case wooden_pickaxe:
                - if <yaml[<[data]>].[quests.active.WoodTools.stages.1.objectives.2.progress]> == 0:
                    ...
                    - run QuestStageProgressHandler def:WoodTools|2 player:<player>
            - case wooden_shovel:
                - if <yaml[<[data]>].[quests.active.WoodTools.stages.1.objectives.3.progress]> == 0:
                    ...
                    - run QuestStageProgressHandler def:WoodTools|3 player:<player>
            - case wooden_sword:
                - if <yaml[<[data]>].[quests.active.WoodTools.stages.1.objectives.4.progress]> == 0:
                    ...
                    - run QuestStageProgressHandler def:WoodTools|4 player:<player>
            - case wooden_hoe:
                - if <yaml[<[data]>].[quests.active.WoodTools.stages.1.objectives.5.progress]> == 0:
                    ...
                    - run QuestStageProgressHandler def:WoodTools|5 player:<player>
