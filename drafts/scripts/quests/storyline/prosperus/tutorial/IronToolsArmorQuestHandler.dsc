...
IronToolsArmorQuestCraftingHandler:
    ...
    events:
        ...
        - choose <context.item.material.name>:
            - case iron_helmet:
                - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.1.objectives.1.progress]> == 0:
            ...
            - case iron_chestplate:
                - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.1.objectives.2.progress]> == 0:
            ...
            - case iron_leggings:
                - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.1.objectives.3.progress]> == 0:
            ...
            - case iron_boots:
                - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.1.objectives.4.progress]> == 0:
            ...
            - case iron_axe:
                - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.1.objectives.5.progress]> == 0:
            ...
            - case iron_pickaxe:
                - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.1.objectives.6.progress]> == 0:
            ...
            - case iron_shovel:
                - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.1.objectives.7.progress]> == 0:
            ...
            - case iron_sword:
                - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.1.objectives.8.progress]> == 0:
            ...
            - case iron_hoe:
                - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.1.objectives.9.progress]> == 0:
...
IronToolsArmorQuestDeliveryHandler:
    ...
    - choose <player.item_in_hand.material.name>:
        ...
        - case iron_boots:
            - define objective:4
            - if <yaml[<[data]>].[quests.active.<[quest_internalname]>.stages.<[stage]>.objectives.4.progress]> == 0:
                - take iron_boots
