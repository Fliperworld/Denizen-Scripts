...
Veteran_Flame_Helm:
    ...
    debug: false
    no_id: true
    material: Leather_Helmet[nbt_attributes=li@generic.maxHealth/head/0/4.0|generic.armorToughness/head/0/2.0|generic.armor/head/0/2.0;nbt=li@equipment_type/armor|item_tier/veteran|armor_set/veteran_flame|fire_magic_power/25|enable_mana/true;lore=<proc[lore_builder].context[40|<script.yaml_key[lore_list].escaped>]>]
    display name: "<&9>Smoldering Leather Helm"
    lore_list:
    - "<&9><&o>Veteran"
    - "<&f>This helm is warm to the touch, radiating the energy of fire magic."
...
Veteran_Flame_Chest:
    ...
    debug: false
    no_id: true
    material: Leather_Chestplate[nbt_attributes=li@generic.maxHealth/chest/0/8.0|generic.armorToughness/chest/0/2.0|generic.armor/chest/0/4.0;nbt=li@equipment_type/armor|item_tier/veteran|armor_set/veteran_flame|fire_magic_power/60|enable_mana/true;lore=<proc[lore_builder].context[40|<script.yaml_key[lore_list].escaped>]>]
    display name: "<&9>Smoldering Leather Chestplate"
    lore_list:
    - "<&9><&o>Veteran"
    - "<&f>This chestplate is warm to the touch, radiating the energy of fire magic."
...
Veteran_Flame_Legs:
    ...
    debug: false
    no_id: true
    material: Leather_Leggings[nbt_attributes=li@generic.maxHealth/legs/0/6.0|generic.armorToughness/legs/0/2.0|generic.armor/legs/0/3.0;nbt=li@equipment_type/armor|item_tier/veteran|armor_set/veteran_flame|fire_magic_power/40|enable_mana/true;lore=<proc[lore_builder].context[40|<script.yaml_key[lore_list].escaped>]>]
    display name: "<&9>Smoldering Leather Leggings"
    lore_list:
    - "<&9><&o>Veteran"
    - "<&f>These leggings are warm to the touch, radiating the energy of fire magic."
...
Veteran_Flame_Boots:
    ...
    debug: false
    no_id: true
    material: Leather_Boots[nbt_attributes=li@generic.maxHealth/feet/0/2.0|generic.armorToughness/feet/0/2.0|generic.armor/feet/0/2.0;nbt=li@equipment_type/armor|item_tier/veteran|armor_set/veteran_flame|fire_magic_power/25|enable_mana/true;lore=<proc[lore_builder].context[40|<script.yaml_key[lore_list].escaped>]>]
    display name: "<&9>Smoldering Leather Boots"
    lore_list:
    - "<&9><&o>Veteran"
    - "<&f>These boots are warm to the touch, radiating the energy of fire magic."
