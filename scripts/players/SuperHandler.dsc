...
"Super Reset on Equip":
    ...
    events:
        ...
        - if <context.armor.contains[lore=&ss5&ssoLegendary]>
        {
...
"Super Enable on Login":
    ...
    events:
        on player joins:
        - wait 20t
        - if <player.equipment.chestplate.contains[lore=&ss5&ssoLegendary]>
        {
            - wait 100t
            - yaml id:super-counter set energy.<player.uuid>:0
...
"Damage Super Charge":
    ...
    events:
        ...
        - if <context.damager.equipment.chestplate.contains[lore=&ss5&ssoLegendary]>
        {
